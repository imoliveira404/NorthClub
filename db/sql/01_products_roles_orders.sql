-- Futz — estrutura principal da loja (cópia consolidada e comentada)
-- Rode este arquivo em um projeto Supabase novo para recriar tudo.
-- As migrations aplicadas automaticamente ficam em supabase/migrations/.
